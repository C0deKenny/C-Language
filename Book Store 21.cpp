...
//ini adalah program perpustakaan yang dapat melakukan
//penambahan buku, menjual buku, garage sell, pembelian buku, dan penghapusan data buku
...
int main(void)
{
    ...
    strcpy(list[0].bookName, "One Punch Man");
    list[0].bookPrice = 100;
    list[0].bookQty = 15;
    strcpy(list[1].bookName, "Romeo and Juliet");  
    list[1].bookPrice = 200;
    list[1].bookQty = 20;    
    strcpy(list[2].bookName, "Detective Conan");   
    list[2].bookPrice = 150;
    list[2].bookQty = 12;
    strcpy(list[3].bookName, "Harry Potter");
